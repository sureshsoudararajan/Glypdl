...
### Windows
* **Configuration**: `%LOCALAPPDATA%\Glypdl\settings.json`
* **Cookie Profiles**: `%LOCALAPPDATA%\Glypdl\cookies\profiles.json`
* **History Database**: `%LOCALAPPDATA%\Glypdl\glypdl.db`
